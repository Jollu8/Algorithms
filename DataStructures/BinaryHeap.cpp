...
public:
    ...
    BinaryHeap(const BinaryHeap& another) noexcept;
    BinaryHeap(BinaryHeap&& another) noexcept;
...
private:
    ...
    [[nodiscard]] std::size_t getIndexRightChild(std::size_t curIndex) const noexcept;
    [[nodiscard]] std::size_t getIndexParent(std::size_t curIndex) const noexcept;
